...
- No STL27L wire protocol or representative payload is defined in the repository. Keep the presence ingress protocol-neutral until an external sensor contract is available; do not infer occupancy from an invented payload.
